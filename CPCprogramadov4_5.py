...
def funcjulconfestproc():
    ...
    while True:
        ...
        if despachojulconfestproc == 'a':
            ...
            print('O julgamento parcial do mérito, nos termos do art. 355 do CPC, como o próprio nome define,')
            ...
            print('Sobre essa decisão, é importante notar como os parágrafos do art. 355 definirão o decorrer')
            ...
            print('requerimento para tanto), como é possível verificar nos dois incisos do art. 354 do CPC.')
            ...
            print('Na prática, o despacho saneador é menos complexo do que a comparação com as outras opções desse menu')
            print('fazem parecer, o que não tira importância dele.')
            print('Destaque-se a situação de estabilização do despacho em 5 dias, nos termos do art. 357 1º,')
            print('que será importante para a discussão recursal das próximas versões do CPC Programado.')
            return despachojulconfestproc
